  ...
  try {
    ...
    if (data.status === 'APPROVED') {
      ...
      if (!existingMatricNumber) {
        ...
        const matricNo = `IMS/${year}/${String(count + 1).padStart(5, '0')}`;
