      ...
      const fetchPrograms = async () => {
        ...
        try {
          const response = await api.get(
            `/applicant/programs?departmentId=${selectedDepartmentId}`
          );
      ...
      {isSubmitted && (
        <Alert className="border-green-500 bg-green-50">
          ...
          <AlertDescription className="text-green-800">
            ...
            currently under review by the admissions committee. You will be
      ...
      {!isSubmitted && (
        <Alert className="border-blue-500 bg-blue-50">
          ...
          <AlertDescription className="text-blue-800">
            Please complete all sections of the application form below. All
            fields are required.
          </AlertDescription>
        </Alert>
      )}
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                {errors.gradeAverage && (
                  <p className="text-sm text-destructive">
                    {errors.gradeAverage.message}
                  </p>
                )}
                <p className="text-xs text-gray-500">
                  Enter your average grade as a percentage. For example, if your
                  CGPA is 3.5/4.0, enter 87.5
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                >
                  ...
                  <SelectContent>
                    {Object.entries(PROGRAM_TYPE_LABELS).map(
                      ([value, label]) => (
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={
                    (applicant as any)?.departmentId?.toString() || undefined
                  }
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  defaultValue={
                    (applicant as any)?.programId?.toString() || undefined
                  }
                  disabled={
                    isSubmitted || !selectedDepartmentId || loadingPrograms
                  }
                >
                  <SelectTrigger>
                    <SelectValue
