...
import { getApplicationStatusColor, getApplicationStatusText } from '@/lib/api-applicant';
...
export default function ApplicantDashboardPage() {
  ...
  const hasCompletedProfile = applicant.dateOfBirth && applicant.gender && applicant.address;
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Welcome to your application dashboard. Track your admission progress here.
        </p>
      </div>
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Your current admission application status</CardDescription>
            </div>
            <div className="flex items-center gap-2">
              <Badge className={getApplicationStatusColor(applicant.applicationStatus)}>
        ...
        <CardContent>
            ...
            <div className="flex items-start space-x-3 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  Your application has been submitted and is currently being reviewed by the admissions committee. 
          ...
          {isPending && !hasCompletedProfile && (
            <div className="flex items-start space-x-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              ...
              <div>
                <p className="font-medium text-blue-900">Complete Your Application</p>
                <p className="text-sm text-blue-700 mt-1">
                  You need to complete your application form with your personal and academic information.
                </p>
          ...
          {isApproved && (
            <div className="flex items-start space-x-3 p-4 bg-green-50 border border-green-200 rounded-lg">
              ...
              <div className="flex-1">
                <p className="font-medium text-green-900">Congratulations! Application Approved</p>
                ...
                {applicant.hasMatricNumber && applicant.matricNo && (
                  <div className="mt-3 p-3 bg-white border border-green-300 rounded-md">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-xs text-green-700 font-medium">Your Matric Number</p>
                        <p className="text-lg font-bold text-green-900 font-mono">{applicant.matricNo}</p>
                      </div>
                    </div>
                  </div>
                )}
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Follow these steps to complete your admission process</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>View and update your application details</CardDescription>
          </CardHeader>
          <CardContent>
            <Button asChild variant="outline" className="w-full">
              <Link href="/applicant/application">
                {hasCompletedProfile ? 'View Application' : 'Complete Application'}
              </Link>
            </Button>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {isApproved ? 'Pay your acceptance fee' : 'Payment pending approval'}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button variant="outline" className="w-full" disabled={!isApproved}>
              {isApproved ? 'Make Payment' : 'Not Available Yet'}
            </Button>
          </CardContent>
        </Card>
      </div>
